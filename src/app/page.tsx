    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[60vh] md:h-[80vh]">
        ...
        <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12">
          <p className="text-sm uppercase tracking-[0.3em] text-zinc-400">Photography</p>
        </div>
      </section>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <span className="text-2xl md:text-3xl lg:text-4xl font-black tracking-tight text-zinc-500 group-hover:text-white transition-colors">
                    {capability}
                  </span>
                </div>
            ...
            <div className="lg:pr-12 lg:border-r lg:border-zinc-800 flex flex-col justify-center order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {["Python", "ML", "Vision", "Cloud", "Next.js", "API"].map((tech) => (
                  <span key={tech} className="px-4 py-2 text-sm font-medium text-zinc-400 border border-zinc-700">
                    {tech}
                  </span>
                ))}
              </div>
      ...
      <section className="py-24 md:py-32 bg-white text-black">
        <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
          <p className="text-3xl md:text-4xl lg:text-5xl font-light leading-tight mb-8">
            &ldquo;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.&rdquo;
          </p>
      ...
      <section className="py-24 md:py-32 bg-black">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-800">
            {[
              { title: "The Fleet", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor." },
              { title: "The Models", description: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi." },
              { title: "The Foundation", description: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum." },
              { title: "The Workflow", description: "Excepteur sint occaecat cupidatat non proident sunt in culpa qui officia." },
              { title: "The Edge", description: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium." },
              { title: "The Method", description: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit." },
            ].map((item) => (
